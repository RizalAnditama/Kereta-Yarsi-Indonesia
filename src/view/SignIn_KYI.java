...
public class SignIn_KYI extends javax.swing.JFrame {
     ...
     */
    public SignIn_KYI(UserController userController) {
        initComponents();
    ...
    private void buttonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLoginActionPerformed
        ...
        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please fill out your username!", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please fill out your password!", "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        SignUp_KYI signUp = new SignUp_KYI(userController);
