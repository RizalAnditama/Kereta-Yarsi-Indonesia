...
public class SignUp_KYI extends javax.swing.JFrame {
    ...
    private void buttonSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSignUpActionPerformed
        ...
        String confirmPassword = new String(textCPassword.getPassword()).trim();

        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Create a username first", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (userController.getUserByUsername(username) != null) {
            JOptionPane.showMessageDialog(this, "Username is used. Try another!", "Info", JOptionPane.INFORMATION_MESSAGE);
        } else if (password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Create a password", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, "Confirm your password", "Warning", JOptionPane.WARNING_MESSAGE);
